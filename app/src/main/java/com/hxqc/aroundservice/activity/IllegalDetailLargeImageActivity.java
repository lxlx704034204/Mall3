...
import com.hxqc.aroundservice.fragment.LargeImageFragment;
 ...
 * Todo 大图显示页面
 */
public class IllegalDetailLargeImageActivity extends BackActivity {

//    ImageInfoFragment imageInfoFragment;
    private LargeImageFragment imLargeImageFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imLargeImageFragment = new LargeImageFragment();
//        imageInfoFragment = new ImageInfoFragment();
//        imageInfoFragment.setArguments(bundle);
        imLargeImageFragment.setArguments(bundle);
        getSupportFragmentManager().beginTransaction().replace(R.id.thread_info_photo_content_layout,
                imLargeImageFragment).setCustomAnimations(R.anim.abc_fade_in, R.anim.abc_fade_out).commit();
        initView();
    }
