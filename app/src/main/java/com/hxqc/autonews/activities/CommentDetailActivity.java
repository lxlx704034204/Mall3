...
import com.hxqc.autonews.fragments.CommentDetailFragment;
 ...
 */
public class CommentDetailActivity extends BackActivity implements View.OnClickListener, CommentDetailAdapter.OnClickListener {

    public static final String INFO_ID = "info_id";
    public static final String P_COMMENT_ID = "p_comment_id";
    public String infoID, pCommentID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pCommentID = getIntent().getBundleExtra(ActivitySwitchBase.KEY_DATA).getString(P_COMMENT_ID);
        ...
        if (id == R.id.comment_dialog) {
            ...
            if (content.length() != 0) {
                if (content.length() < 10) {
                    //字数少了
                    ToastHelper.showYellowToast(CommentDetailActivity.this, "评价长度不符");
    ...
    @Override
    public void onReply(String cCommentID) {
        this.mCCommentID = cCommentID;
        showDialog();
    }
    ...
    private void send(String content) {
        client.sendAutoInfoComment(infoID, pCommentID, mCCommentID, content, new LoadingAnimResponseHandler(this, true) {
            @Override
            public void onSuccess(String response) {
                ToastHelper.showGreenToast(CommentDetailActivity.this, "评价成功");
                mDialog.dismiss();
            }
        });
    }
