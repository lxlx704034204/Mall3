 ...
 */
public class PublicCommentListAdapter extends BaseAdapter {
    ...
    public PublicCommentListAdapter(boolean isShowCar, Context mContext, ArrayList<UserGradeComment> mComment, OnClickListener mListener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.item_public_comment, null);
        ...
        if (null == model.images || model.images.size() == 0) {
            ...
            mViewHolder.mRecyclerView.setAdapter(new CommentPhotoAdapter(model.images, mContext));
        }
