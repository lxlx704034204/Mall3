 ...
 */
public class PublicCommentPagerFragment extends LazyFragment implements OnRefreshHandler, PublicCommentListAdapter.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_public_comment_pager, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new PublicCommentListAdapter(true, getContext(), mComment, this);
    ...
    private void loadData(boolean hasLoadingAnim) {
        isDataLoaded = true;
        client.requestMyGrades(mPage, new LoadingAnimResponseHandler(getContext(), hasLoadingAnim) {
            @Override
            public void onSuccess(String response) {
                ArrayList<UserGradeComment> temp = JSONUtils.fromJson(response, new TypeToken<ArrayList<UserGradeComment>>() {
                });
    ...
    @Override
    public void onDelete(String gradeID) {
        client.deleteAutoGrade(gradeID, new LoadingAnimResponseHandler(getContext(), true) {
            @Override
            public void onSuccess(String response) {
