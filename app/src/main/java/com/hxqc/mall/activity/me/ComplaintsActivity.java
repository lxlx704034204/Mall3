 ...
 * Todo 客户投诉
 */
public class ComplaintsActivity extends BackActivity implements View.OnClickListener, ControllerConstruct, FilterBrandFragment.FilterBrandFragmentCallBack, View.OnFocusChangeListener, DrawerLayout.DrawerListener {
...
//                "<font color=\"#e02c36\">400-1868-555</font></p>"));
        watchOutInfo.setText(Html.fromHtml(getString(R.string.info_complaint_watch_out)));
        ...
        new UserApiClient().sendFeedback(phoneNumber, advice, currentFeedbackOption.adviceID,
                ...
                , new LoadingAnimResponseHandler(this, true) {
                    ...
                    public void onSuccess(String response) {
                        ToastHelper.showGreenToast(ComplaintsActivity.this, "提交成功！");
