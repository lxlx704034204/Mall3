...
//	public static final int AnticipateOvershoot = 7;
	...
	private static void setEffect(Animation animation, long durationMillis, long delayMillis) {
		switch (AnimationController.Default) {
			case 0:
	...
	private static void baseIn(View view, Animation animation, long durationMillis, long delayMillis) {
		setEffect(animation, durationMillis, delayMillis);
