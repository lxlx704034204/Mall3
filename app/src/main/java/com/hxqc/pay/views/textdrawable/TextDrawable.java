package com.hxqc.pay.views.textdrawable;//package com.hxqc.hxqcmall.pay.views.textdrawable;
//
...
//    }
//
//    public static IShapeBuilder builder(int textColor,int fontSize1,boolean isBold1) {
//        return new Builder(textColor,fontSize1,isBold1);
//    }
//
//    @Override
...
//        }
//
//        public Builder(int textColor1,int fontSize1,boolean isBold1){
//            text = "";
//            color = Color.GRAY;
