...
public class SliderLayout extends RelativeLayout {
    ...
    //    boolean isCanCycle = true;
    public ImageView sliderOnlyOneView;
//    private Context mContext;
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        LayoutInflater.from(context).inflate(R.layout.sliderimage_slider_layout, this, true);
        ...
        sliderOnlyOneView = (ImageView) findViewById(R.id.image_auto_slider);
    ...
    public void setSliderOnlyOneView(String url) {
        sliderOnlyOneView.setVisibility(VISIBLE);

        if (sliderOnlyOneView != null) {
            if (!TextUtils.isEmpty(url)) {
                Glide.with(getContext())
                        .load(url)
                        .centerCrop()
                        .placeholder(R.drawable.sliderimage_pic_normal_slider)
                        .crossFade()
                        .into(sliderOnlyOneView);
            } else {
                Glide.with(getContext())
                        .load(R.drawable.sliderimage_pic_normal_slider)
                        .centerCrop()
                        .placeholder(R.drawable.sliderimage_pic_normal_slider)
                        .crossFade()
                        .into(sliderOnlyOneView);
...
//    public void setViewPagerParent(ViewGroup pagerParent) {
//        mViewPager.setNestParent(pagerParent);
//    }
