...
public class HeaderStore {
    ...
    public final HashMap< Long, View > headersViewByHeadersIds;
    public final HashMap< Long, Integer > headersViewByPosition;
    ...
    public HeaderStore(RecyclerView parent, StickyHeadersAdapter adapter, boolean isSticky) {
        ...
        this.headersViewByHeadersIds = new LinkedHashMap<>();
        this.wasHeaderByItemId = new HashMap<>();
        this.isHeaderByItemPosition = new ArrayList<>();
        this.headersHeightsByItemsIds = new HashMap<>();
        this.headersViewByPosition = new HashMap<>();
    }
    ...
    public View getHeaderViewByItem(RecyclerView.ViewHolder itemHolder) {
        ...
        if (!headersViewByHeadersIds.containsKey(headerId)) {
            ...
            headersViewByPosition.put(headerId, itemPosition);
        }
