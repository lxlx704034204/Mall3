...
+'/pgyer/signed_7zip_aligned.apk ${WORKSPACE}/config/market_pgyer.txt ${WORKSPACE}/bakApk/V'+`${args[0]}-${args[1]}-${args[2]}/pgyer`;
exec(cmd, function(err,stdout,stderr){
    ...
    var cmd = 'curl -F "file=@${WORKSPACE}/bakApk/V'+`${args[0]}-${args[1]}-${args[2]}/pgyer/`+'signed_7zip_aligned-pgyer.apk" -F "uKey=b7b7c394273b4a322c6c581454322ece" -F "_api_key=01a6c110c8ca950f35eb85722ae5d037" https://www.pgyer.com/apiv1/app/upload';
	exec(cmd, function(err,stdout,stderr){
	    if(err) {
