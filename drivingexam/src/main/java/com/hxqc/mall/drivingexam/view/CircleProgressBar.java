...
public class CircleProgressBar extends View {
    ...
    private int progressStrokeWidth = (int) getResources().getDimension(R.dimen.dp_4);
    private int marxArcStorkeWidth = (int) getResources().getDimension(R.dimen.dp_4);
    // 画圆所在的距形区域
    RectF oval;
    Paint paint;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(Color.parseColor("#E12C35"));
