...
public class ThirdShopAutoModelExpandableAdapter extends BaseExpandableListAdapter implements PinnedHeaderExpandableListView.OnHeaderUpdateListener {
    ...
    ArrayList<AutoModelGroup> modelArrayList;
    private String series;

    public ThirdShopAutoModelExpandableAdapter(Context context, ArrayList<AutoModelGroup> modelGroups, String series) {
    ...
    public void notifyData(ArrayList<AutoModelGroup> modelGroups, String series) {
        this.modelArrayList = modelGroups;
        this.series = series;
    ...
    public int getChildrenCount(int groupPosition) {
        return modelArrayList == null ? 0 : modelArrayList.get(groupPosition).autoModel.size();
    }

    @Override
    public String getGroup(int groupPosition) {
        return modelArrayList.get(groupPosition).year;
    }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        textView.setText(modelArrayList.get(groupPosition).year);
        return convertView;
    }
    ...
    public AutoModel getChild(int groupPosition, int childPosition) {
        return modelArrayList.get(groupPosition).autoModel.get(childPosition);
    }
