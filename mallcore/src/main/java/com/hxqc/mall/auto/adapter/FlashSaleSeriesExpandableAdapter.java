 ...
 * Todo 选择车型
 */
public class FlashSaleSeriesExpandableAdapter extends BaseExpandableListAdapter implements PinnedHeaderExpandableListView.OnHeaderUpdateListener {
    ...
    public FlashSaleSeriesExpandableAdapter(Context context, ArrayList<SeriesGroup> autoSeriesGroup) {
...
//        convertView.setClickable(true);
    ...
    public View getChildView(int groupPosition, int childPosition,
        ...
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.item_flash_sale_seriesexpandable_child, null);
            ...
            TextView mSeriesPrice = (TextView) convertView.findViewById(R.id.item_auto_price);
            childHolder = new ChildHolder(mSeriesLogoView, mSeriesNameView, mSeriesPrice);
    ...
    class ChildHolder {
        private final TextView mSeriesPriceView;
        TextView mSeriesNameView;
        ImageView mSeriesLogoView;

        ChildHolder(ImageView mSeriesLogoView, TextView mSeriesNameView, TextView mSeriesPriceView) {
            this.mSeriesLogoView = mSeriesLogoView;
            this.mSeriesNameView = mSeriesNameView;
            this.mSeriesPriceView = mSeriesPriceView;
        }

        public void setValue(Series autoAutoSeries) {
            mSeriesNameView.setText(String.format("%s系列车型", autoAutoSeries.seriesName));
            mSeriesPriceView.setText(OtherUtil.formatPriceSingleOrRange(autoAutoSeries.priceRange));
            if (TextUtils.isEmpty(autoAutoSeries.seriesThumb)) {
                mSeriesLogoView.setImageResource(R.drawable.pic_normal);
            } else {
                ImageUtil.setImage(mContext, mSeriesLogoView, autoAutoSeries.seriesThumb);
            }
        }
    }
}
