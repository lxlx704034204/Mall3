...
//    private PlateNumberTextView mLicenseNumView;//车牌号
    ...
    private TextView mMaintainView;//保养时间及公里数
    ...
    private final LinearLayout mPlateNumberParentView;

    public CommenAutoInfoHeaderView(Context context, AttributeSet attrs) {
        super(context, attrs);
        View view = LayoutInflater.from(context).inflate(R.layout.layout_commen_auto_info, this);
...
//        mLicenseNumView = (PlateNumberTextView) view.findViewById(R.id.commen_auto_info_license_number);
        ...
        mPlateNumberParentView = (LinearLayout) findViewById(R.id.commen_auto_info_plate_number_parent);
