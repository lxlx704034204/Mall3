...
public class SwipeMenuLayout extends FrameLayout {
    ...
    public static final int ANIM_DURING = 350;
    ...
    public void smoothCloseMenu() {
        ...
        if (mSwipeDirection == SwipeMenuListView.DIRECTION_LEFT) {
            ...
            mCloseScroller.startScroll(0, 0, mMenuView.getWidth(), 0, ANIM_DURING);
        } else {
    ...
    public void smoothOpenMenu() {
        ...
        state = STATE_OPEN;
        if (mSwipeDirection == SwipeMenuListView.DIRECTION_LEFT) {
            mOpenScroller.startScroll(-mContentView.getLeft(), 0, mMenuView.getWidth(), 0, ANIM_DURING);
        } else {
            mOpenScroller.startScroll(mContentView.getLeft(), 0, mMenuView.getWidth(), 0, ANIM_DURING);
        }
        postInvalidate();
