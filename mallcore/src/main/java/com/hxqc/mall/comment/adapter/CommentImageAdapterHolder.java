 ...
 * Todo
 */
public class CommentImageAdapterHolder extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context context;
    OnItemClickListener mItemClickListener;
    private ArrayList<ImageModel > mData;

    public CommentImageAdapterHolder(ArrayList<ImageModel> mData) {
        this.mData = mData;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View sView = mInflater.inflate(R.layout.comment_list_item_image, parent, false);
...
//                Toast.makeText(context, "0_0" + position, Toast.LENGTH_SHORT).show();
                ActivitySwitchBase.toViewLagerPic(position, mData, context, bundle);
            }
        });
    }
