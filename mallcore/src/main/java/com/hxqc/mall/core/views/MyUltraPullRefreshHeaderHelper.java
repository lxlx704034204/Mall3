...
public class MyUltraPullRefreshHeaderHelper extends UltraPullRefreshHeaderHelper implements PtrHandler {
    ...
    int recyclerTop = 0;
    private boolean canDoPullRefresh = true;


    /** 控制不可下路刷新 **/
    public void setCanDoPullRefresh(boolean canDoPullRefresh) {
        this.canDoPullRefresh = canDoPullRefresh;
    }
    ...
    public boolean checkCanDoRefresh(PtrFrameLayout ptrFrameLayout, View content, View header) {
        ...
        return canDoPullRefresh && controlView.getTop() >= recyclerTop && PtrDefaultHandler.checkContentCanBePulledDown(ptrFrameLayout, controlView, header);
    }
