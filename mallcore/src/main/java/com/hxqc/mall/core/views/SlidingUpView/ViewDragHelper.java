...
public class ViewDragHelper {
    ...
    public static ViewDragHelper create(ViewGroup forParent, float sensitivity, Interpolator interpolator, Callback cb) {
        ...
        helper.mTouchSlop = (int) (helper.mTouchSlop * (1 / sensitivity));
        DebugLog.e(TAG, " ViewDragHelper  -------------- mTouchSlop : "  + helper.mTouchSlop);
        return helper;
    }
    ...
    private boolean forceSettleCapturedViewAt(int finalLeft, int finalTop, int xvel, int yvel) {
        ...
        // callback the animation duration
        mCallback.animationDuration(duration);
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                if (mDragState == STATE_DRAGGING) {
                    ...
                    DebugLog.e(TAG, " ViewDragHelper processEvent ========= idx :  " + idx + "  idy : " + idy);
