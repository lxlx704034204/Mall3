...
public class AutofitLayout extends FrameLayout {
    ...
    private WeakHashMap<View, com.hxqc.mall.core.views.autotext.AutofitHelper > mHelpers = new WeakHashMap<>();
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        ...
        com.hxqc.mall.core.views.autotext.AutofitHelper helper = com.hxqc.mall.core.views.autotext.AutofitHelper.create(textView)
                .setEnabled(mEnabled);
        if (mPrecision > 0) {
    ...
    /**
     * Returns the {@link com.hxqc.mall.core.views.autotext.AutofitHelper} for this child View.
     */
    public com.hxqc.mall.core.views.autotext.AutofitHelper getAutofitHelper(TextView textView) {
