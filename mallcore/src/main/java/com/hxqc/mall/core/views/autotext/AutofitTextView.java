 ...
 */
public class AutofitTextView extends TextView implements com.hxqc.mall.core.views.autotext.AutofitHelper.OnTextSizeChangeListener {

    private com.hxqc.mall.core.views.autotext.AutofitHelper mHelper;
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        mHelper = com.hxqc.mall.core.views.autotext.AutofitHelper.create(this, attrs, defStyle)
    ...
    /**
     * Returns the {@link com.hxqc.mall.core.views.autotext.AutofitHelper} for this View.
     */
