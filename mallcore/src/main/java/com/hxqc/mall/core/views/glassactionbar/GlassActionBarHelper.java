 ...
 */
package com.hxqc.mall.core.views.glassactionbar;
...
public class GlassActionBarHelper implements OnGlobalLayoutListener, com.hxqc.mall.core.views.glassactionbar.NotifyingScrollView.OnScrollChangedListener, com.hxqc.mall.core.views.glassactionbar.BlurTask.Listener, com.hxqc.mall.core.views.glassactionbar.ListViewScrollObserver.OnListViewScrollListener {
    ...
    private int blurRadius = com.hxqc.mall.core.views.glassactionbar.GlassActionBar.DEFAULT_BLUR_RADIUS;
    private com.hxqc.mall.core.views.glassactionbar.BlurTask blurTask;
    private int lastScrollPosition = -1;
    private com.hxqc.mall.core.views.glassactionbar.NotifyingScrollView scrollView;
    private ListView listView;
    private int downSampling = com.hxqc.mall.core.views.glassactionbar.GlassActionBar.DEFAULT_DOWNSAMPLING;
    private static final String TAG = "GlassActionBarHelper";
    private boolean verbose = com.hxqc.mall.core.views.glassactionbar.GlassActionBar.verbose;
    ...
    public View createView(Context context) {
     ...
     // Need to get resource id of style pointed to from actionBarStyle
        ...
        content = inflater.inflate(contentLayout, frame, false);
        ...
        if (content instanceof com.hxqc.mall.core.views.glassactionbar.NotifyingScrollView) {
            if (verbose) Log.v(TAG, "ScrollView content!");
            scrollView = (com.hxqc.mall.core.views.glassactionbar.NotifyingScrollView) content;
            scrollView.setOnScrollChangedListener(this);
        } else if (content instanceof ListView) {
            if (verbose) Log.v(TAG, "ListView content!");
            listView = (ListView) content;
            listView.setAdapter(adapter);
            com.hxqc.mall.core.views.glassactionbar.ListViewScrollObserver observer = new com.hxqc.mall.core.views.glassactionbar.ListViewScrollObserver(listView);
    ...
    public void setBlurRadius(int newValue) {
        if (!com.hxqc.mall.core.views.glassactionbar.GlassActionBar.isValidBlurRadius(newValue)) {
    ...
    public void setDownsampling(int newValue) {
        if (!com.hxqc.mall.core.views.glassactionbar.GlassActionBar.isValidDownsampling(newValue)) {
    ...
    public void onGlobalLayout() {
        ...
        if (listView != null) {
            ...
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(MeasureSpec.UNSPECIFIED, MeasureSpec.UNSPECIFIED);
        }
    ...
    private void computeBlurOverlay() {
        ...
        scaled = com.hxqc.mall.core.views.glassactionbar.Utils.drawViewToBitmap(scaled, content, width, height, downSampling, windowBackground);
    ...
    private void startBlurTask() {
        ...
        blurTask = new com.hxqc.mall.core.views.glassactionbar.BlurTask(frame.getContext(), this, scaled, blurRadius);
    }
    ...
    private void updateBlurOverlay(int top, boolean force) {
        ...
        if (isBlurTaskFinished()) {
            ...
            blurredBitmap = com.hxqc.mall.core.views.glassactionbar.Blur.apply(frame.getContext(), actionBarSection);
        }
