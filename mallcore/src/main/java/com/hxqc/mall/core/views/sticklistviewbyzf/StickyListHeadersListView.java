...
/**
 * ps: 更改了adapter中分组id类型，long -> string.  zf
 * <p>
...
public class StickyListHeadersListView extends FrameLayout {
    ...
    private OnLoadingMoreLinstener loadMoreListener;
    ...
    private boolean isStartOfSection(int position) {
        return position == 0 || !mAdapter.getHeaderId(position).equals(mAdapter.getHeaderId(position - 1));
    }
    ...
    public void setOnLoadMoreListener(OnLoadingMoreLinstener listener) {
