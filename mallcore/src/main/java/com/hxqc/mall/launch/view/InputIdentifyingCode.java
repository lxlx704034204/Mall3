 ...
 */
public class InputIdentifyingCode extends RelativeLayout {
    ...
    public InputIdentifyingCode(Context context) {
        super(context);
    }

    public InputIdentifyingCode(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater inflater = LayoutInflater.from(context);
        inflater.inflate(R.layout.view_input_identifying_code, this);
