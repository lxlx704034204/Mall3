...
public class ImageDisplayer {
	...
	public ImageDisplayer(Context context) {
		Context context1;
		if (context.getApplicationContext() != null) context1 = context
				.getApplicationContext();
		else
			context1 = context;

		DisplayMetrics dm = context1.getResources().getDisplayMetrics();
	...
	private void showDefault(ImageView iv) {
		iv.setBackgroundResource(R.drawable.pic_normal);
	}
