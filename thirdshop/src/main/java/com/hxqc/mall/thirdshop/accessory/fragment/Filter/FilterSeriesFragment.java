...
import com.hxqc.mall.thirdshop.accessory.adapter.CarSeriesRecyclerViewAdapter;
 ...
 * 袁秉勇
 */
public class FilterSeriesFragment extends FunctionFragment implements FilterController.SeriesHandler, CarSeriesRecyclerViewAdapter.carSeriesRecyclerViewCallBack {
    ...
    FilterSeriesFragmentCallBack filterSeriesFragmentCallBack;
    LinearLayoutManager linearLayoutManager;
    LinearLayout mBrandNameTipView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_filter_series, container, false);
        }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (carSeriesRecyclerViewAdapter == null && brand != null) getData(brand.brandName, brand.brandID, true);
    }
     ...
     * @param brandName
     */
    public void getData(@NonNull String brandName, String brandID, boolean showLoading) {
        brand = new Brand(brandName);
        filterController.requestAccessorySeries(mContext, brandID, this, showLoading);
    }
