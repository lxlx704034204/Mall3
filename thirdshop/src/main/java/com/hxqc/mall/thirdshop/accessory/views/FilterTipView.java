 ...
 */
public class FilterTipView extends LinearLayout implements View.OnClickListener {
    ...
    ListView mBrandConditionRightView, mClassConditionLeftView, mClassConditionRightView;
    ...
    public FilterTipView(final Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        View root = LayoutInflater.from(context).inflate(R.layout.view_filter_tip, this);
    ...
    private void initData() {
        new AccessoryApiClient().getProductListFilter(new LoadingAnimResponseHandler(getContext(), false) {
            @Override
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.filter_tip_brand) {
            if (null == mProductListFilter || null == mProductListFilter.brandSeries || 0 == mProductListFilter.brandSeries.size()) {
                initData();
            } else {
        ...
        switch (ID) {
            case -1: //品牌
                ...
                if (null == mBrandConditionLeftAdapter) {
                    ...
                    mBrandConditionLeftAdapter = new CustomBrandExpandableAdapter(getContext(), mProductListFilter.brandSeries);
                    ...
                    mBrandConditionLeftView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
                        ...
                        public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                            ...
                            for (BrandGroup bg : mProductListFilter.brandSeries) {
                                for (Brand b : bg.group) {
                                    b.isChecked = false;
                                }
                            }
                            Brand brand = mProductListFilter.brandSeries.get(groupPosition).group.get(childPosition);
                            ...
                            if (null == mBrandConditionRightAdapter) {
                                ...
                                mBrandRightHeaderView.setOnClickListener(new OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        mBrandRightPosition = -1;
                                        mBrandView.setText(mProductListFilter.brandSeries.get(mGroupPosition).group.get(mChildPosition).brandName);
                                        hideConditionRootView();
                                        mStatus = Status.UNSELECTED;
                                        updateStatus();
                                        if (null != mOnFilterClickListener)
                                            mOnFilterClickListener.onBrandClick(mProductListFilter.brandSeries.get(mGroupPosition).group.get(mChildPosition).brandID, "");
                                    }
                                });
                                ...
                                mBrandConditionRightView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                        if (position != 0) {
                                            ...
                                            updateStatus();
                                            if (null != mOnFilterClickListener)
                                                mOnFilterClickListener.onBrandClick(mProductListFilter.brandSeries.get(mGroupPosition).group.get(mChildPosition).brandID, mSeries.get(position - 1).seriesID);
                                        }
                                    }
                                });
                            }
                            mSeries.clear();
                            mSeries.addAll(brand.series);
                ...
                if (mGroupPosition != -1 && mChildPosition != -1) {
                    ...
                    Brand brand = mProductListFilter.brandSeries.get(mGroupPosition).group.get(mChildPosition);
                    brand.isChecked = true;
                    mBrandConditionLeftAdapter.notifyDataSetChanged();
    ...
    public interface OnFilterClickListener {
        void onBrandClick(String brandID, String seriesID);
