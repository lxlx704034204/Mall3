 ...
 */
public class ProductInOrder extends LinearLayout {
    ...
    public ProductInOrder(Context context) {
        super(context);
    }

    public ProductInOrder(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void fillData(ProductInfo productInfo, boolean toProductDetail) {
