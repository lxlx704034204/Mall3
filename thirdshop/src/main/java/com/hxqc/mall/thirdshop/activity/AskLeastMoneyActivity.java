 ...
 * @since 2015年12月01日
 */
public class AskLeastMoneyActivity extends BackActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener, CityChooseFragment.OnAreaChooseInteractionListener, ChooseIntentCarFragment.ChooseIntentCarListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCustomerCityView.setText(String.format("%s %s", sharedPreferencesHelper.getProvince(), sharedPreferencesHelper.getCity()));
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.customer_intent_car_type) {
            ...
            if (!TextUtils.isEmpty(mCustomerIntentCarTypeView.getText()) && !TextUtils.isEmpty(mCustomerCityView.getText()) && !TextUtils.isEmpty(mCustomerNameView.getText()) && !TextUtils.isEmpty(mCustomerPhoneView.getText())) {
                ...
                mThirdPartShopClient.submitMessage(shopID, itemID, mDeliveryAddress.city, mDeliveryAddress.cityID, mDeliveryAddress.province, mDeliveryAddress.provinceID, mCustomerPhoneView.getText() + "", mCustomerNameView.getText() + "", sex + "", "10", applyPlacement + "", new LoadingAnimResponseHandler(AskLeastMoneyActivity.this) {
                            @Override
                            ...
                            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                                ...
                                ToastHelper.showRedToast(AskLeastMoneyActivity.this, "信息提交失败，请再试一次，如有问题请反馈，我们会及时处理，谢谢您的配合");
                            }
                        });
            } else {
