 ...
 * Date: 2015/12/1
 */
public class Filter4SBrandFragment extends FunctionFragment implements BaseFilterController.TBrandHandler, ExpandableListView.OnChildClickListener, View.OnClickListener {
    private final static String TAG = Filter4SBrandFragment.class.getSimpleName();
...
//        DebugLog.e(TAG, " ApiClient request time " + System.currentTimeMillis());
        ...
        mSiteID=getActivity().getIntent().getBundleExtra(ActivitySwitchBase.KEY_DATA).getString(ActivitySwitcherThirdPartShop.SITE_ID);
        baseFilterController.request4SShopBrand(getActivity(), mSiteID, this);//获取车辆品牌列表
    }
...
//        DebugLog.e(TAG, " --------- onStart ");
    ...
    public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
        if (filterBrandFragmentCallBack != null)
            filterBrandFragmentCallBack.onFilterBrandCallback(brandGroups.get(groupPosition).group.get(childPosition));
        return false;
    }
    ...
    private TextView createHeaderView(Context context) {
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (filterBrandFragmentCallBack != null)
                    filterBrandFragmentCallBack.onFilterBrandCallback(null);
            }
        });
        return textView;
    }
    ...
    public void onClick(View v) {
        ...
        if (filterBrandFragmentCallBack != null)
            filterBrandFragmentCallBack.onFilterBrandCallback(brand);
    }
