...
// * 袁秉勇
// */
//public class Filter4SSeriesFragment extends FunctionFragment implements BaseFilterController.TSeriesHandler, CarSeriesRecyclerViewAdapter.carSeriesRecyclerViewCallBack {
//    private final static String TAG = Filter4SSeriesFragment.class.getSimpleName();
//
...
//
//
//    public Filter4SSeriesFragment() {
//    }
//
//
//    public static Filter4SSeriesFragment newInstance(Brand brand,String siteID) {
//        Filter4SSeriesFragment fragment = new Filter4SSeriesFragment();
//        Bundle args = new Bundle();
//        args.putParcelable("brand", brand);
//        args.putString(ActivitySwitcherThirdPartShop.SITE_ID, siteID);
...
//            this.mSiteID = getArguments().getString(ActivitySwitcherThirdPartShop.SITE_ID);
//        }
//    }
//
//
...
//
//        if (carSeriesRecyclerViewAdapter == null && brand != null)
//            getData(brand.brandName, mSiteID, true);
//    }
//
//
//    @Override
...
//     * @param brandName
//     */
//    public void getData(@NonNull String brandName, String siteID, boolean showLoading) {
...
//            }
//        }
//        baseFilterController.request4SShopSeries(mContext, siteID, brandName, this, showLoading);
//    }
//
//
//    @Override
...
//                    }
//                } else {
//                    if (mBrandNameTipView.getVisibility() == View.VISIBLE)
//                        mBrandNameTipView.setVisibility(View.GONE);
//                }
//            }
//        });
//    }
