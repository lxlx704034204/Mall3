 ...
 * Todo 车系列表的适配器
 */
public class AutoBrandsListAdapter extends BaseExpandableListAdapter implements OnHeaderUpdateListener {
    private ArrayList<BrandGroup> mData;
    private Context mContext;

    public AutoBrandsListAdapter(ArrayList<BrandGroup> mData, Context mContext) {
        this.mData = mData;
        this.mContext = mContext;
    }

    public void notifyData(ArrayList<BrandGroup> mData) {
        this.mData = mData;
    ...
    public void updatePinnedHeader(View headerView, int firstVisibleGroupPos) {
        ...
        textView.setText(getGroup(firstVisibleGroupPos).groupTag);
    }
    ...
    class ChildHolder {
        ...
        public void setValue(Brand brand) {
            nameView.setText(brand.brandName);
            ImageUtil.setImage(mContext, imageView, brand.brandThumb);
        }
    }
}
