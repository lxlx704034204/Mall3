...
import com.hxqc.mall.thirdshop.maintenance.adapter.BrandExpandableAdapter;
...
/**
 * Function:常规保养品牌筛选Fragment
 *
 * @author 袁秉勇
 * @since 2016年02月16日
 */
public class FilterBrandFragment extends FunctionFragment implements FilterController.BrandHandler, ExpandableListView.OnChildClickListener {
...
//        heardView.setBackgroundResource(R.drawable.pic_list_title);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        filterController.requestMaintenanceBrand(getActivity(), this);//获取车辆品牌列表
    }
