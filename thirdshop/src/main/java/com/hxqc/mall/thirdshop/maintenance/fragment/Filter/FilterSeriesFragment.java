package com.hxqc.mall.thirdshop.maintenance.fragment.Filter;
...
import com.hxqc.mall.thirdshop.maintenance.adapter.CarSeriesRecyclerViewAdapter;
...
public class FilterSeriesFragment extends FunctionFragment implements FilterController.SeriesHandler, CarSeriesRecyclerViewAdapter.carSeriesRecyclerViewCallBack {
    ...
    public void getData(@NonNull String brandName, boolean showLoading) {
        ...
        filterController.requestMaintenanceSeries(mContext, brandName, this, showLoading);
    }
