...
public class FourSNewsItem extends LinearLayout {
    ...
    public FourSNewsItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public void addData(final FourSNews fourSNews) {
        ImageUtil.setImage(getContext(), mNewsPhotoView, fourSNews.thumb);
            ...
            public void onClick(View v) {
                ...
                switch (fourSNews.newsKind) {
                    ...
                    case 40:
                        ...
                        break;
                    case 50:
                        ActivitySwitchMaintenance.toMaintenancePromotion(fourSNews.promotion.promotionID, getContext());
                        break;
                    case 60:
                        ActivitySwitcherThirdPartShop.toSalesNewsDetail(fourSNews.promotion.promotionID, getContext());
                        break;
                }
            }
        });
